...
const ListarTarefa = () => {
  ...
  const statusColorsMap = {
    'Concluída' : {color: 'green'},
    'Em Andamento' : {color: 'blue'},
    'Aguardando' : {color: 'grey'}
  }
    ...
    <Card>
        ...
        <CardContent>
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                <TableHead sx={{ backgroundColor: `blanchedalmond`}}>
                <TableRow>
                    <TableCell>#</TableCell>
                    <TableCell sx={fw600} >Título</TableCell>
                    <TableCell align="right" sx={fw600}>Descrição</TableCell>
                    <TableCell align="right" sx={fw600}>Data de Início</TableCell>
                    <TableCell align="right" sx={fw600}>Data de Finalização</TableCell>
                    <TableCell align="right" sx={fw600}>Status</TableCell>
                    <TableCell align="right" sx={fw600}>Recurso</TableCell>
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right" sx={{...statusColorsMap[row.statusTarefa], fontWeight: 500}}>{row.statusTarefa}</TableCell>
